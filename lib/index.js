...
console.log(chalk.whiteBright("[+] Developer: SATURN07\n[+] Fork: SOCKETON - Ibra Decode"));
...
console.log(chalk.gray("--------------------"));
console.log(chalk.cyan("[!] Cari Nokos, Panel, Role Panel, Dll? Langsung aja"))
console.log(chalk.whiteBright("wa.me/6285137572401\nt.me/kaaaoffc311\nkaaaoffc.web.id\n"));
